...
# Run derivative simulations in DRN with GABA adaptation grafted onto 5HT
for baseline_ in "-0.080" "-0.060" "-0.040" "-0.020" "0.000" "0.020" "0.040" "0.060" "0.080"; do
	deriv_input=../../data/simulations/GIF_network/deriv_input_adaptation_swap_ser_only/"$baseline_"_baseline/input.dat
	...
	for i in $(seq 0 $[$REPEATS - 1]); do
		...
		../../data/models/GIF_network/GIFnet_${i}_subsample_adaptation_swap_ser_only.mod \
		$deriv_input \
