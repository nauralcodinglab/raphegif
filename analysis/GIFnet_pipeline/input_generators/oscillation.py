...
cos_wave = stimtools.SquareWaveStimulus(
...
full_stimulus = stimtools.concatenate([pad_stimulus, cos_wave,])

oscillation_stimulus = {
...
if args.verbose:
    print('Saving oscillation stimulus to {}'.format(args.output))
with open(args.output, 'wb') as f:
    pickle.dump(oscillation_stimulus, f)
    f.close()
if args.verbose:
    print('Done!')
