...
PROCESSED_PATH = os.path.join('data', 'processed', '5HT_fastnoise')
print 'Saving {} `good` and `bad` cells separately in {}'.format(len(experiments), PROCESSED_PATH)

with open(os.path.join(PROCESSED_PATH, '5HT_goodcells.ldat'), 'wb') as f:
    pickle.dump(experiments, f)
    f.close()

with open(os.path.join(PROCESSED_PATH, '5HT_badcells.ldat'), 'wb') as f:
